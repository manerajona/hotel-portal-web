...
<div id="reservation-table">
    ...
    <div class="table table-sm">
        <input id="txtReservation" type="text" class="form-control form-control-sm" onkeyup="filterReservations(event)"
            placeholder="Buscar reservaciones..">

        <table id="tbReservation" class="table table-striped table-light">
                ...
                <c:forEach var="reservation" items="${reservations}">
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <c:if test="${param.isEditable == true}">
